/*
     ...
     USA
*/
// Per-platform warm-path baselines for bench_warm_path.cpp.
//
...
// ">= 5% improvement vs baseline" acceptance criterion, hardened
// into a real CI gate (phrased as fail-on-regression:
...
//   below. See test/PERFORMANCE.md for the procedure.
//
...
// (TODO) until they are re-measured on their respective CI
// runners. They are set deliberately loose so the gate never produces a
// false failure before they are calibrated; they are NOT a tight
...
// Any C++ stdlib on Linux. TODO: re-measure on the
...
#elif defined(_WIN32)
// MSVC STL. TODO: re-measure on a Windows runner and tighten.
