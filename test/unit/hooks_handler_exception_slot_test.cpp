...
// TASK-049 design pin: the internal_error_handler alias lives in a
...
// in the chain (DR-012 §4.10): user-added handler_exception hooks via
// add_hook get a chance to recover BEFORE the internal_error_handler
// fallback. Placing the alias at index 0 in the vector (the TASK-048
